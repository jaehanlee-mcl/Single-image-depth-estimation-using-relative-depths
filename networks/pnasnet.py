...
class PNASNet5Large(nn.Module):
    ...
    def get_features(self, x):
        ...
        x_cell_10 = self.cell_10(x_cell_8, x_cell_9)
        x_cell_11 = self.cell_11(x_cell_9, x_cell_10)
        return x, x_conv_0, x_stem_0, x_stem_1, x_cell_4, x_cell_11
    ...
    def get_features_max(self, x):
        ...
        x_d08 = torch.cat((x_stem_1, x_cell_0, x_cell_1, x_cell_2, x_cell_3), dim=1)
        x_d16 = torch.cat((x_cell_7, x_cell_6, x_cell_5, x_cell_4), dim=1)
        x_d32 = torch.cat((x_cell_11, x_cell_10, x_cell_9, x_cell_8), dim=1)
        return x, x_conv_0, x_stem_0, x_d08, x_d16, x_d32
