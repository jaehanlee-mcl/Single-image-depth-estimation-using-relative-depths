...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, num_classes=1001, stem_filters=96, penultimate_filters=4032, filters_multiplier=2):
        ...
        self.conv0.add_module('conv', nn.Conv2d(in_channels=3, out_channels=self.stem_filters, kernel_size=3, padding=1, stride=2,
                                                bias=False))
    ...
    def get_features(self, x):
        ...
        x_cell_16 = self.cell_16(x_cell_15, x_cell_14)
        x_cell_17 = self.cell_17(x_cell_16, x_cell_15)
        return x, x_conv0, x_stem_0, x_stem_1, x_cell_6, x_cell_17
